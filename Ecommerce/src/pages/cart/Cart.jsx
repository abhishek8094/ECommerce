    ...
    <Layout>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl justify-center px-6 md:flex md:space-x-6 xl:px-0 ">
                ...
                >
                  ...
                  <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                    <div className="mt-5 sm:mt-0">
                      ...
                      <p
                        className="mt-2 text-[19px] font-semibold text-gray-700"
                        style={{ color: mode === "dark" ? "white" : "" }}
                      >
                        ₹{price}
                      </p>
                    </div>
                    <div className="flex-start mt-[70px]">
                      <div className="flex justify-center">
                        <button
                          className="bg-[#08d1eb] text-black w-10 h-10 p-2 rounded-md"
                        ...
                        <button
                          className="bg-[#b613e8] w-10 text-black h-10 p-2 rounded-md"
                      ...
                      >
                        <svg
                          ...
                          strokeWidth={1.5}
                          stroke="currentColor"
                          className="w-6 h-20 relative left-10"
                        >
                          <path
                            strokeLinecap="round"
          ...
          >
            <h1 className="font-bold text-center text-xl p-2">Order Summary</h1>
